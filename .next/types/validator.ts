...
// Validate ../../src/app/api/product-images/route.ts
{
  type __IsExpected<Specific extends RouteHandlerConfig<"/api/product-images">> = Specific
  const handler = {} as typeof import("../../src/app/api/product-images/route.js")
  type __Check = __IsExpected<typeof handler>
  // @ts-ignore
  type __Unused = __Check
}
